...
CREATE DATABASE IF NOT EXISTS QUICKSTART_<firstname>_<lastname>_{{environment}}; 


-- Parametrize the USE SCHEMA in steps/03_harmonize_data.sql
use schema quickstart_<firstname>_<lastname>_{{environment}}.silver;


-- Parametrize the USE SCHEMA in steps/04_orchestrate_jobs.sql
use schema quickstart_<firstname>_<lastname>_{{environment}}.gold;
