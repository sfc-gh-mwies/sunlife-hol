...
show parameters like 'data_retention_time_in_days' in table quickstart_<firstname>_<lastname>_dev.gold.vacation_spots;
-- should return 1 (due to deploy_pipeline_dev.yml)
show parameters like 'data_retention_time_in_days' in table quickstart_<firstname>_<lastname>_prod.gold.vacation_spots;
